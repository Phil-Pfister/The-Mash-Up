        ...
        <div className="container bg-gray-200 rounded p-4 mx-auto">
          <div className="max-w-xl lg:max-w-6xl mx-auto">
            <div className="flex flex-wrap -mx-4 mb-12">
              <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
                <div className="w-full h-[50%]">
                  <a className="relative group block mb-6 h-full w-full bg-blueGray-900 rounded-md" href="#">
                    <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                      <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src={drums} alt="">
                        </img>
                    </div>
                  </a>
                  <div className="flex flex-wrap -mx-3 -mb-3 justify-between">
                    <div className="w-1/2 xs:w-1/4 px-3 mb-3">
                      <a className="relative group block h-24 w-full bg-blueGray-900 rounded-md" href="#">
                        <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                          <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src={drums} alt="">
                            </img>
                        </div>
              ...
              <div className="w-full lg:w-1/2 px-4">
                <div className="max-w-lg">
                  ...
                  <span className="block text-sm font-bold mb-5">Seller's Username</span>
                  ...
                  <span className="block text-2xl font-black text-green-700 mb-4">$ 199.00</span>
                  <p className="font-bold mb-2">Pariatur ex aliqua elit ut enim consequat amet non do ut. Ad aute deserunt fugiat qui Lorem in quis velit labore voluptate.</p>
                  ...
                  <div className="flex flex-wrap sm:flex-nowrap items-center -mx-2 mb-6">
                    <div className="flex-grow-1 w-full px-2 mb-4">
                      <a className="group relative inline-block h-12 w-full -mb-2 bg-blueGray-900 rounded-md" href="#">
                        <div className="absolute top-0 left-0 transform -translate-y-1 -translate-x-1 w-full h-full group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                          <div className="flex h-full w-full items-center justify-center bg-[#fc2403] border-2 border-black rounded-md hover:bg-black hover:border-[#fc2403]">
                            <span className="text-base font-black text-white">Add to Cart</span>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div className="w-auto px-2 mb-4">
                      <a className="inline-flex items-center justify-center w-12 h-12 text-black hover:text-indigo-500 border-2 border-black hover:border-indigo-500 rounded-md transition duration-200" href="#">
            ...
            <div className="mb-8 border-b-2 border-black">
              <div className="flex flex-col md:flex-row -mb-px"><a className="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-black text-[#fc2403] border-b-4 border-[#fc2403]" href="#">Description</a><a className="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-bold text-black" href="#">Customer Reviews</a><a className="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-bold text-black" href="#">Shipping &amp; Returns</a></div>
            </div>
            <div>
              <h4 className="text-xl font-black mb-3">Lorem ipsum dolor sit amet</h4>
              <p className="text-lg font-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            </div>
          </div>
        </div>
      </section>
